// services/ingestor-jira/api-ingestor.js (VERSIÓN FINAL Y COMPLETA)
...
// --- AJUSTE FINAL: Incluimos los dos campos personalizados que descubrimos ---
const JIRA_FIELDS = [
    "summary", "issuetype", "status", "priority", "resolution",
    "assignee", "reporter", "created", "updated", "duedate",
    "project", "customfield_10020", // Campo para Sprint
    "customfield_12439"  // Campo para Story Points
].join(',');
    ...
    while (!isLast) {
        ...
        try {
            ...
            const cleanedIssues = pageData.issues.map(issue => {
                // Lógica para extraer el SPRINT del campo correcto
                ...
                return {
                    ...
                    // --- CAMPOS CORREGIDOS Y COMPLETOS ---
                    sprint: sprintName,
                    story_points: issue.fields.customfield_12439 || null
                };
            });
